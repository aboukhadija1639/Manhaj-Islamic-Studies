      ...
      semesters: [
        {
          ...
          subjects: [
            ...
            },
            {
              ...
              references: ['الورقات - الجويني', 'مذكرة أصول الفقه - الشنقيطي', 'الوجيز في أصول الفقه - عبد الكريم زيدان'],
              lectures: [
                { id: 'usul-l1', title: 'تعريف أصول الفقه ومبادئه', titleAr: 'تعريف أصول الفقه ومبادئه', order: 1, descriptionAr: 'تعريف أصول الفقه لغة واصطلاحاً، والفرق بينه وبين الفقه.' },
                { id: 'usul-l2', title: 'نشأة علم أصول الفقه وتدوينه', titleAr: 'نشأة علم أصول الفقه وتدوينه', order: 2, descriptionAr: 'تاريخ العلم منذ عصر الصحابة حتى التدوين الرسمي مع الإمام الشافعي.' },
                { id: 'usul-l3', title: 'الحكم التكليفي', titleAr: 'الحكم التكليفي', order: 3, descriptionAr: 'أقسام الحكم التكليفي الخمسة: الواجب، المندوب، المحرم، المكروه، المباح.' },
                { id: 'usul-l4', title: 'الحكم الوضعي', titleAr: 'الحكم الوضعي', order: 4, descriptionAr: 'أقسام الحكم الوضعي: السبب، الشرط، المانع، الصحة، البطلان.' },
                { id: 'usul-l5', title: 'القرآن الكريم والسنة النبوية', titleAr: 'القرآن الكريم والسنة النبوية', order: 5, descriptionAr: 'حجية الكتاب والسنة ومنزلتهما في التشريع.' },
                { id: 'usul-l6', title: 'الإجماع والقياس', titleAr: 'الإجماع والقياس', order: 6, descriptionAr: 'تعريف الإجماع والقياس وأركانهما وشروطهما.' },
                { id: 'usul-l7', title: 'الأدلة التبعية (المختلف فيها)', titleAr: 'الأدلة التبعية (المختلف فيها)', order: 7, descriptionAr: 'الاستصحاب، المصالح المرسلة، سد الذرائع، عرف، قول الصحابي.' }
              ]
            },
            {
              id: 'l1-s1-arabic',
