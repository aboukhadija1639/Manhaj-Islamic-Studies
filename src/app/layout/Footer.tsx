          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed mb-4 max-w-md">
                منصة تعليمية متكاملة ومتخصصة في العلوم الإسلامية لطلاب جامعة حمه لخضر بالوادي، توفر محتوى علمي منظم ومنهجي وسهل الوصول لجميع الطلاب.
              </p>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href="mailto:info@manhaj.edu.dz" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                    info@manhaj.edu.dz
                  </a>
                </div>
              </div>
