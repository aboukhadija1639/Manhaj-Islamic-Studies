      ...
      <Container>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-slate-900 mb-4">البرامج الأكاديمية</h1>
            ...
            {degrees.map((degree) => (
              <Card key={degree.id} className="p-8 flex flex-col h-full hover:shadow-xl transition-shadow border-t-4 border-t-emerald-500">
                <div className="mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">{degree.nameAr}</h2>
                ...
                <div className="mt-auto pt-6 border-t border-slate-100 flex items-center justify-between">
                  <div className="text-sm text-slate-500">
                    <span className="block font-medium text-slate-700">المدة: {degree.duration.years} سنوات</span>
