    ...
    <div className="py-12 bg-slate-50 min-h-screen" dir="rtl">
      <Container>
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-slate-900 mb-4">{degree.nameAr}</h1>
          <p className="text-lg text-slate-600 max-w-3xl">{degree.description}</p>
        </div>

        <h2 className="text-2xl font-bold text-slate-800 mb-8">التخصصات المتاحة</h2>
