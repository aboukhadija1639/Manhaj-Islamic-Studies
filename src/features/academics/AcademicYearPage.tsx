    ...
    <div className="py-12 bg-slate-50 min-h-screen" dir="rtl">
      <Container>
        <div className="mb-10">
          ...
          <p className="text-slate-600">{degree.nameAr} - {specialty.nameAr}</p>
        </div>
                    ...
                    modules.map((module) => (
                      <Card key={module.id} className="p-4 hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start">
                          <div>
                            <h3 className="font-bold text-slate-900">{module.nameAr}</h3>
                            <p className="text-xs text-slate-500 mt-1">{module.code} • {module.credits} رصيد</p>
                          </div>
